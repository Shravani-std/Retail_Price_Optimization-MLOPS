...
from src._predict import predictor
from src._prediction_service_loader import bentoml_prediction_service_loader
...
def inference_fashion_mnist(
    ...
    """
    inference_data = data_ingestion(table_name="retail_prices", for_predict=True) 
    df_processed = categoricsl_encode(inference_data)
